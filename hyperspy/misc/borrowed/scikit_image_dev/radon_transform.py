...
from .arraypad import pad as util_pad
...
def radon(image, theta=None, circle=False):
    ...
    if circle:
        ...
        padded_image = util_pad(image, pad_width, mode='constant',
                                constant_values=0)
...
def _sinogram_circle_to_square(sinogram):
    ...
    return util_pad(sinogram, pad_width, mode='constant', constant_values=0)
